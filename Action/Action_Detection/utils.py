...
from Action_Detection.Pose.pose_visualizer import TfPoseVisualizer
...
def load_pretrain_model(model):
    dyn_graph_path = {
        'VGG_origin': str(file_path / "Action_Detection/Pose/graph_models/VGG_origin/graph_opt.pb"),
        'mobilenet_thin': str(file_path / "Action_Detection/Pose/graph_models/mobilenet_thin/graph_opt.pb")
    }
